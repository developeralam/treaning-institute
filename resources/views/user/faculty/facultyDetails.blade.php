                    ...
                    <div class="col-12">
                        <figure>
                            <div class="about_thumb">
                                <img class="float-right" src="{{ asset('uploads/faculty/'.$item->image) }}" alt="" style="height: 250px; weight: 350px;">
                            </div>
                                 <a href="{{ route('user.faculty') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
                            <figcaption class="about_content text-center">
                                <h3>{{ ucfirst($item->name) }}</h3>
                               <div class="faculty-details">
                                 <p class="text-center"> <b>Phonjke: </b>{{  ucfirst($item->phone)  }}</p>
                                 <p class="text-center">  <b>Email: </b> {{ $item->email }}</p>
                                  <p class="text-center"> <b>Qualification:</b> {{ $item->qualification }}</p>
                                  <p class="text-center"> <b>Tranning On:</b> {{ $item->tranning }}</p>
                               </div>
                            </figcaption>
