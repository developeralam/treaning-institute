...
@section('page-header')
    <i class="fa fa-list" xmlns="http://www.w3.org/1999/html"></i> Batch
@stop
@section('css')
...
@section('content')
    <div class="page-header">
        <button class="btn btn-xs btn-info" data-toggle="modal" data-target="#example" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</button>
        <h1>
            @yield('page-header')
        </h1>
    </div>
        ...
        <div class="col-xs-12">
            <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
                <table id="dynamic-table" class="table table-striped table-bordered table-hover" >
                    ...
                    @foreach(App\StudentBatch::getAllBatch() as $data)
                        <tr>
                            <td>{{$i++}}</td>
                            ...
                            <td>
                                ...
                                <!-- <a href="{{url('/batch-delete')}}/{{$data->id}}" onclick="return confirm('Are sure to delete??')" class="btn btn-sm btn-danger">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{url('batch/update')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$data->id}}">
                                            <div class="form-group">
                                                <label for="batch_name" class="col-form-label">Batch Name:</label>
                                                <input type="text" class="form-control" name="batch_name" id="batch_name" placeholder="Session" value="{{$data->batch_name}}" min="1">
                                            </div>
                                            <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('batchStore')}}" method="post">
                        ...
                        <div class="form-group">
                            <label for="batch_name" class="col-form-label">Batch Name:</label>
                            <input type="text" class="form-control" name="batch_name" id="batch_name" placeholder="Batch Name" value="{{old('batch_name')}}" min="1">
                        </div>
                        <div class="form-group">
                            <label for="course_id" class="col-form-label">Course Name:</label>
                            <select name="course_id" id="course_id" class="form-control">
