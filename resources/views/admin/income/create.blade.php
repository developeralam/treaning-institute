...
<a style="margin-top: 5px;margin-right: 10px" href="{{ route('income.index')}}" class="btn btn-sm btn-info btn-xs pull-right"> <i class="fa fa-plus"></i> Institute Income List</a>
      ...
      <div class="widget-box" style="margin: 3px -150px;">
         ...
         @include('admin.layouts.includes.msg')
            ...
            <div class="widget-main" style="margin-bottom: 114px;">
               <form class="form-horizontal" method="POST" action="{{ route('income.store') }}" role="form" >
                  {{ csrf_field() }} 
                  <table class="table table-borderd">
                     <thead>
                        <tr>
                           <th width="50%">
                              <label class="col control-label" for="form-field-1-1">  Party Name</label>
                           </th>
                           <th width="50%">
                              <label class="col control-label" for="form-field-1-1"> Payment Date </label>
                           </th>
                        </tr>
                     </thead>
                     <tbody>
                        <td class="col-sm-1">
                           <select class="chosen-select form-control" data-placeholder="Choose a account..." name="party_id"  id="form-field-select-3" >
                  ...
                  <table id="addInput" class="table table-borderd">
                     <thead>
                        <tr>
                           <th>
                              <label class="col control-label" for="form-field-1-1"> Chart of account </label>
                           </th>
                           <th>                                
                              <label class="col control-label" for="form-field-1-1"> Description </label>   
                           </th>

                           <th>
                              <label class="col control-label payable" for="form-field-1-1"> Payable Amount </label>
                           </th>
                           <th>
                             <label class="col control-label payable" for="form-field-1-1"> Paid Amount </label>
                           </th>
                        </tr>
                     </thead>
                     <tbody>
                        ...
                        <td class="col-sm-3">
                           <input type="number" keyup="hello" name="payable" id="payable" placeholder="Payable ammount" class="form-control paid-input" value="{{ old('paid') }}" required />
                        </td>
                        <td class="col-sm-3">
