...
@section('title','Update News Form')
@section('page-header')
    <i class="fa fa-plus-circle"></i> News & Update
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('newsUpdate.store') }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <a href="{{ route('newsUpdate.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
