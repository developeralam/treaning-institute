              ...
              {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('newsUpdate.update',$newsUpdate->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="Text Field" class="form-control @error('title') is-invalid @enderror " name="title" value="{{ $newsUpdate->title }}" />
                                     @error('title')
...
{{--                           <div class="form-group">--}}
{{--                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> File Upload  <h6>file size must be in <b>(510*382)</b> </h6></label>--}}
