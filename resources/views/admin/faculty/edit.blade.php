            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('faculty.update',$faculty->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $faculty->name }}" />
                                     @error('name')
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('designation') is-invalid @enderror" name="designation" value="{{ $faculty->designation }}" />
                                     @error('designation')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                     </span>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('phone') is-invalid @enderror "  pattern="\d*" maxlength="11" minlength="11" name="phone" value="{{ $faculty->phone }}" />
                                     @error('phone')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                     </span>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" id="form-field-1-1"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $faculty->email }}" />
                                     @error('email')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                     </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control" name="qualification" value="{{ $faculty->qualification }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control" name="tranning" value="{{ $faculty->tranning }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <img id="previewLogo" src="/uploads/faculty/{{$faculty->image??null}}" height="60" width="215"/>
                                </div>
                            </div>
                            <div class="form-group">
