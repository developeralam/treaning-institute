...
@section('content')
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{ route('faculty.create') }}" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
        <h1>
            @yield('page-header')
        </h1>
    </div>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ ucfirst($faculty->designation) }} </td>
                            <td> {{ $faculty->phone }} </td>
                            <td> {{ $faculty->email }} </td>
                            <td> {{ $faculty->qualification }} </td>
                            <td> {{ $faculty->tranning }} </td>                          
                            <td> 
                                @if(!($faculty->image=='no'))
                                    <img class="img-responsive img-thumbnail" src="{{ asset('uploads/faculty/'.$faculty->image) }}"  style="height: 50px; weight: 30px;" alt=""> 
                                @else
                                    <img class="img-responsive img-thumbnail" src="{{ asset('uploads/no.png') }}"  style="height: 50px; weight: 30px;" alt=""> 
                                @endif
                            </td>
                            <td>
                                <a href="{{ route('faculty.edit',$faculty->id) }}" class="btn btn-sm btn-success" title="Edit">
                                ...
                                <form action="{{ route('faculty.destroy',$faculty->id)}}" id="delete-form-{{ $faculty->id }}" method="POST">
                                    @csrf
                                    @method("DELETE")
                                </form>
                            </td>
