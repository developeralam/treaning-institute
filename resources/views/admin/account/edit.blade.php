...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Account Edit
@stop
@section('css')
                    ...
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('account.update',$account->id) }}" >
                             ...
                             <div class="form-group">
                                <label class="col-sm-3 control-label" for="name_of_account">Account Name</label>
                                <div class="col-sm-9">
                                    <input type="text" id="name_of_account" placeholder="Text Field" class="form-control" name="name_of_account" value="{{ $account->name_of_account }}" />
                                </div>
                            </div>
                              <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Type of Account</label>
                            <div class="col-sm-9">
                                <label for="1"><input id="1" type="radio" name="type"  value="Income" {{ $account->type == 'income' ? 'checked' : ''}}>
                                    Income &nbsp;&nbsp;</label>
                                <label for="2"><input id="2" type="radio" name="type" value="Expense" {{ $account->type == 'expense' ? 'checked' : ''}}> Expense </label>
                                <label for="3"><input id="3" type="radio" name="type" value="Academic" {{ $account->type == 'academic' ? 'checked' : ''}}> Academic</label>
                                </div>
                            </div>
                           <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <a href="{{ route('account.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
