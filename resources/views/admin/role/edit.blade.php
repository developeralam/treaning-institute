...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Role
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('role.update',$item->id) }}" >
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <a href="{{ route('role.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
