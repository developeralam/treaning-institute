                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('user.store') }}" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                         <input type="password" id="form-field-1-1" placeholder="Password"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" />
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="radio">
                                            <label>
                                                <input name="roles" type="radio" class="ace"  value="1">
                                                <span class="lbl"> Admin</span>
                                            </label>
                                            <label>
                                                <input name="roles" type="radio" class="ace" value="2">
                                                <span class="lbl"> Editor</span>
                                            </label>
                                            <label>
                                                <input name="roles" type="radio" class="ace" value="3">
                                                <span class="lbl"> Publisher </span>
                                            </label>
                                          @foreach ($roles as $role )
                                          <label>
                                                <input name="role_name" type="radio" class="ace" value="{{$role->id}}">
