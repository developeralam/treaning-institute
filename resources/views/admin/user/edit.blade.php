            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('user.update',$item->id) }}" >
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" id="form-field-1-1"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $item->email }}" />
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            {{-- <div class="form-group">
                                    <label class="col-sm-3 control-label" for="form-field-1-1"> Password</label>
    
                                    <div class="col-sm-9">
                                        <input type="password" id="form-field-1-1"  class="form-control @error('password') is-invalid @enderror" name="password" value="{{ $item->password }}" />
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                {{-- <div class="form-group">
                                    <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> Role</label>
    
                                    <div class="col-xs-12 col-sm-9">
                                        <div class="radio">
                                            <label>
                                                <input name="roles" type="radio" class="ace"  value="{{$item->roles}}"  @if($item->roles == 1) checked @endif>
                                                <span class="lbl"> Admin</span>
                                            </label>
                                            <label>
                                                <input name="roles" type="radio" class="ace"  value="{{$item->roles}}"  @if($item->roles == 2) checked @endif>
                                                <span class="lbl"> Editor</span>
                                            </label>
                                            <label>
                                                <input name="roles" type="radio" class="ace"  value="{{$item->roles}}"  @if($item->roles == 3) checked @endif>
                                                <span class="lbl"> Publisher </span>
                                            </label>
                                            @foreach ($roles as $role )
                                          <label>
                                                <input name="roles" type="radio" class="ace" value="{{$role->id}}"  @if($item->roles == $role->id) checked @endif >
