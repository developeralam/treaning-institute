...
@section('title','MMIT Services')
@section('page-header')
    <i class="fa fa-list"></i>MMIT Services
@stop
@section('css')
...
@section('content')
    ...
    <div class="page-header">
         <a class="btn btn-xs btn-info" href="{{ route('service.create') }}" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
                    ...
                    <tr>
                       <td> {{ $key +1 }} </td>
                            <td> {{ ucfirst($item->name) }} </td>
                             ...
                             <td>
                                @if(!($item->image=='no'))
                                <img class="img-responsive img-thumbnail" src="{{ asset('uploads/service/'.$item->image) }}"  style="height: 50px; weight: 30px;" alt="">
                                @else
                               <img class="img-responsive img-thumbnail" src="{{ asset('uploads/no.png') }}"  style="height: 50px; weight: 30px;" alt="">
                               @endif
                        </td>
                         <td>
                            <a href="{{ route('service.edit',$item->id) }}" class="btn btn-sm btn-success" title="Edit">
                            ...
                            <form action="{{ route('service.destroy',$item->id)}}" id="delete-form-{{ $item->id }}" method="POST">
                                @csrf
                                @method("DELETE")
                            </form>
                         </td>
