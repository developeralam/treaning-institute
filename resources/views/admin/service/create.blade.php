        ...
        <div class="col-sm-12">
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('service.store') }}"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="url" id="weblink" placeholder="Weblink"  class="form-control @error('weblink') is-invalid @enderror " name="weblink" value="{{ old('weblink') }}" />
                                      @error('weblink')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" id="rank" placeholder="rank"  class="form-control @error('rank') is-invalid @enderror " name="rank" value="{{ old('rank') }}" step="1" min="1" />
                                      @error('rank')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                    ...
                    <div class="form-group">
                        <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> Upload Service Image  <h6>Image size must be in <b>(510x382)px</b> </h6></label>
