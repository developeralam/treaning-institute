...
@section('title','Success Student Form')
@section('page-header')
    <i class="fa fa-plus-circle"></i> Success Student
@stop
@section('css')
          ...
          {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('successStudent.update',$items->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('name') is-invalid @enderror " name="name" value="{{ $items->name }}" />
                                         @error('name')
                              ...
                              <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Course</label>

                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('post') is-invalid @enderror " name="post" value="{{ $items->post }}" />
                                    @error('post')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label">  Upload success Student Image <h6>file size must be in <b>(250x250)px</b> </h6></label>

                                <div class="col-xs-12 col-sm-6">

                                    <input multiple="" type="file" id="id-input-file-3" name="image" />
                                    <img id="previewLogo" src="/uploads/successstudent/{{$items->image??null}}" height="60" width="215"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                 ...
                                 <a href="{{ route('successStudent.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
