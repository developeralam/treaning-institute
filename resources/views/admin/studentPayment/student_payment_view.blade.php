...
@section('title','Money Reciept')
@section('page-header')
<i class="fa fa-plus-circle"></i> Money Reciept
@stop
@section('css')  
...
{{--                                          </div><!-- /.col --> --}}
                                          ...
                                          <div class="row">
                                             <div class="col-xs-12 text-center">
                                                <h3 style="margin-top: 0px;" ><b>Money Reciept</b></h3>
                                             </div>
                                          </div> 
                                          <div class="col-sm-12  col-md-6  col-xs-6">
                                             <div>
                                                <ul class="list-unstyled  spaced">
                                                   <li>
                                                      <i class="ace-icon fa fa-caret-right green"></i>Student Name : {{$student->student_name}}
                                                   </li> 
                                                   <li>
                                                      <i class="ace-icon fa fa-caret-right green"></i>Course Name : {{$course->title}}
                                                   </li> 
                                                   <li>
                                                      <i class="ace-icon fa fa-caret-right green"></i>Email : {{$student->email}}
                                                   </li>
                                                   <li>
                                                      <i class="ace-icon fa fa-caret-right green"></i>Phone : {{$student->phone}}
                                                   </li> 
                                                </ul>
                                             </div>
                                          </div><!-- /.col -->
                                          <div class="col-sm-12 col-md-6 col-xs-6">
                                             <div class="widget-toolbar no-border invoice-info">
                                                <span class="red">Student Id: {{$data->student_id}}</span>
                                                <br>
                                                <span class="red">Voucher No: {{$data->id}}</span>

                                                <br />
                                                <span class="invoice-info-label">Date:</span>
                                                <span class="blue">{{$data->date}}</span>
                                             </div>
