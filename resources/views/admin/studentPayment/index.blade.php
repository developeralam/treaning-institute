...
@section('page-header')
<i class="fa fa-list"></i> Student Payment
@stop
@section('css')
...
<div class="page-header">
   ...
   <a class="btn btn-xs btn-info" href="/admin/student-payment/create" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
   <h1>
      @yield('page-header')
   </h1>
</div>
   ...
   <div class="col-xs-12">
      <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
         <table id="dynamic-table" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              @foreach(App\StudentPayment::getAllStudentPayment() as $payment)
               <tr>
                  <td>{{ $loop->index+1 }}</td>
                  ...
                  <td>
                     <a href="{{url('student-income')}}/{{$payment->id}}" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
                     ...
                     <form action="{{ route('student-payment.destroy',$payment->id)}}" id="delete-form-{{ $payment->id }}" method="POST">
                        @csrf
                        @method("DELETE")
                     </form>
                  </td>
