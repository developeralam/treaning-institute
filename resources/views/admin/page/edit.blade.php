...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Pages
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('page.update',$item->id) }}" >
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                        ...
                        <div class="col-md-8">
                            <textarea rows="8" name="desc" class="form-control @error('desc') is-invalid @enderror" >{{ old('desc', $item->desc??null) }}</textarea>
                            @error('desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <a href="{{ route('page.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
