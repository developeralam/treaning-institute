              ...
              {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="col-md-8">
                            <textarea rows="8" name="desc" placeholder="Description"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Description'" class="form-control @error('desc') is-invalid @enderror" >{{ old('desc') }}</textarea>
                            @error('desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
