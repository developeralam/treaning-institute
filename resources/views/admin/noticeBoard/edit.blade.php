...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Notice Board 
@stop
@section('css')
          ...
          {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('notice-board.update',$item->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                        ...
                        <div class="col-md-8">
                            <textarea rows="8" name="description" class="form-control @error('description') is-invalid @enderror" >{{ old('description', $item->description??null) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                           ...
                           <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> Upload (PDF/Image)</label>
                                <div class="col-xs-12 col-sm-8 col-md-8">
                                    <input multiple="" type="file" id="id-input-file-3" name="file" />
                                    <embed id="previewLogo" src="{{asset( $item->file??null )}}" src="file_name.pdf" height="60" width="100%" class="img-thumbnail" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                 ...
                                 <a href="{{ url('admin/notice-board') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
