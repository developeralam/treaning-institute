          ...
          {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('notice-board.store') }}"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea rows="8" name="description" placeholder="Description"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Description'" class="form-control @error('description') is-invalid @enderror" >{{ old('description', $item->description??null) }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label">  Upload PDF</b> </h6></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <a href="{{ route('notice-board.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
