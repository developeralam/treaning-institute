...
@section('page-header')
    <i class="fa fa-list"></i> Notice Board
@stop
@section('css')
...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{ route('notice-board.create') }}" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
    ...
    {{--  <td>
      ...
      <embed src="{{ asset('uploads/noticeboard/'.$item->file) }}" type="application/pdf" height="50px" width="65px">
      ...
      @endif
             ...
             <td>
                 <a href="{{ route('notice-board.edit',$item->id) }}" class="btn btn-sm btn-success" title="Edit">
         ...
         <a  class="btn btn-sm btn-danger" title="Delete" onclick="if(confirm('Are you sure to delete')){
            ...
            event.preventDefault();
                            ...
                            <form action="{{ route('notice-board.destroy',$item->id)}}" id="delete-form-{{ $item->id }}" method="POST">
                                @csrf
                                @method("DELETE")
                            </form>
