...
@section('content')
@section('bread-link')
    <a href="{{route('incomeduelist')}}" class="btn btn-danger btn-sm" style="float:right; margin-top:2px;">Income Due Payment List</a>
@endsection
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form action="{{route('incomeDue.store')}}" method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label for="student_name">Party Name</label>
                                                <input type="text" class="form-control" id="party_name" name="party_name" value="{{App\Income::partyname($income->party_id)}}" readonly="">
                                            </div>
                                            <div class="form-group">
                                                <label for="income_id">Income Id</label>
                                                <input type="text" class="form-control" id="income_id" value="{{$income->id}}" name="income_id" readonly="">
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label for="due_amount">Due Amount</label>
                                                        <input type="text" class="form-control" value="{{$income->due_amount}}" name="due_amount" readonly=""> 
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
