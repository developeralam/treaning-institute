...
@section('title','Expence Due Recive')
@section('page-header')
   <span class="hidden-print"><i class="fa fa-plus-circle"></i> Expence Due Recive</span> 
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    ...
                    <div class="row" id="student_payment_report"> 
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                            <h5 class="text-center">Expence Due Recive</h5>
