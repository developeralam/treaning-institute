...
@section('title','Portfolio Form')
@section('page-header')
    <i class="fa fa-plus-circle"></i> Portfolio
@stop
@section('css')
               ...
               {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('portfolio.update',$item->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea rows="8" style="resize: vertical;"  name="description" class="form-control @error('description') is-invalid @enderror" >{{ old('description', $item->description??null) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label">  Upload portfolio image  <h6>Image size must be in <b>(510x382)px</b> </h6></label>

                                <div class="col-xs-12 col-sm-6">

                                    <input multiple="" type="file" id="id-input-file-3" name="image" />
                                    <img id="previewLogo" src="/uploads/portfolio/{{$item->image??null}}" height="60" width="215"/>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    {{-- <button class="btn btn-gray" type="Reset"> <i class="fa fa-refresh"></i> Reset</button> --}}
                                     <a href="{{ route('portfolio.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
