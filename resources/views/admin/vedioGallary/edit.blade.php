...
@section('title','Vedio Gallary Form')
@section('page-header')
    <i class="fa fa-plus-circle"></i> Vedio Gallary
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('vedioGallary.update',$item->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                            <div class="form-group">
                                <label for="youtube" class="col-xs-12 col-sm-3 col-md-3 control-label">Youtube Embded Link</label>
                                <div class="col-xs-12 col-sm-6">
                                    <textarea name="vedio" class="form-control" id="" cols="30" rows="6">{{$item->vedio}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    {{-- <button class="btn btn-gray" type="Reset"> <i class="fa fa-refresh"></i> Reset</button> --}}
                                     <a href="{{ route('vedioGallary.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
