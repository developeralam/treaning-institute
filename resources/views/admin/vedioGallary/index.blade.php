...
@section('title','Vedio Gallary')
@section('page-header')
    <i class="fa fa-list"></i> Vedio Gallary
@stop
@section('css')
...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{ route('vedioGallary.create') }}" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover" >
                    ...
                    <tr>
                       <td> {{ $key +1 }} </td>
                        ...
                        <td>
                            <a href="{{ route('vedioGallary.edit',$item->id) }}" class="btn btn-sm btn-success" title="Edit">
                            ...
                            <form action="{{ route('vedioGallary.destroy',$item->id)}}" id="delete-form-{{ $item->id }}" method="POST">
                                @csrf
                                @method("DELETE")
                            </form>
                        </td>
