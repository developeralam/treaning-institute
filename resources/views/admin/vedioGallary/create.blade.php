              ...
              @include('admin.layouts.includes.msg')
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('vedioGallary.store') }}">
                            @csrf
                           <div class="form-group">
                                <label for="youtube" class="col-xs-12 col-sm-3 col-md-3 control-label font-weight-bold">Youtube Embded Link</label>
                                <div class="col-xs-12 col-sm-6">
                                    <textarea name="youtube_link" class="form-control" id="" cols="30" rows="6" required=""></textarea>
                                </div>
                           </div>
                            <div class="form-group">
