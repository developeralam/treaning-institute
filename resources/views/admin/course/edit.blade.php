...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Course 
@stop
@section('css')
               ...
               {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('course.update',$item->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                             <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Title <span class="text-danger">*</span></label>

                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $item->title }}" />
                                    @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" id="short_code" placeholder="Course Code"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'"  class="form-control @error('title') is-invalid @enderror" name="short_code" value="{{ $item->short_code }}"/>
                                    @error('short_code')
                                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
...
{{--                                            <textarea name="desc" id="desc" data-provide="markdown" data-iconlibrary="fa" rows="10" placeholder="*** Write down course details here ***">{{ $item->desc }}</textarea>--}}
                                            <textarea id="summernote" name="desc">{{ $item->desc }}</textarea>
                                            <script>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Duration <span class="text-danger">*</span></label>

                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('duration') is-invalid @enderror" name="duration"
                                           value="{{ $item->duration }}" />
                                     @error('duration')
                                         <span class="invalid-feedback" role="alert">
                                             <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="day"  class="form-control  @error('day') is-invalid @enderror " name="day" value="{{ $item->day }}" />
                                    @error('day')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="hour"  class="form-control  @error('hour') is-invalid @enderror " name="hour" value="{{ $item->hour }}" />
                                    @error('hour')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Fees</label>

                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control" name="fees" value="{{ $item->fees }}" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label">  Upload course image <h6>File size must be in <b>(510x382)px</b> </h6></label>

                                <div class="col-xs-12 col-sm-6">
                                    
                                    <input multiple="" type="file" id="id-input-file-3" name="image" />
                                    <img id="previewLogo" src="/uploads/course/{{$item->image??null}}" height="60" width="215"/>
