...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Message
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('messagePost') }}"  enctype="multipart/form-data">
                                  @csrf
                                 
                             <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Name of Message</label>

                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('name') is-invalid @enderror "  name="name" value="{{ $items->name??null }}" />
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
        {{--                            <textarea rows="8" name="desc" class="form-control @error('desc') is-invalid @enderror">{{ old('desc', $items->desc??null) }}</textarea>--}}
                                    <textarea id="summernote" name="desc">{{$items->desc}}</textarea>
                                    <script>
                                        $('#summernote').summernote({
                                            placeholder: 'Chairmain message',
                                            tabsize: 2,
                                            height: 100
                                        });
                                    </script>
                    ...
                    <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1">Message By</label>

                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1" placeholder="message by" class="form-control @error('by') is-invalid @enderror " name="by" value="{{ $items->by??null }}" />
                                     @error('by')
                                        <span class="invalid-feedback" role="alert">
                                           <strong>{{ $message }}</strong>
                                       </span>
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-3">Upload Message Image <h6>file size must be in <b>( 201x204 )</b> </h6></label>
                        <div class="col-md-8" title="file size must be in (201x204) ">
                            ...
                            <img id="previewLogo" src="/uploads/message/{{$items->image??null}}" height="60" width="215"/>
