...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{ route('party.create') }}" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
             ...
             <td>
                 <a href="{{ route('party.edit',$item->id) }}" class="btn btn-sm btn-success" title="Edit">
         ...
         <a  class="btn btn-sm btn-danger" title="Delete" onclick="if(confirm('Are you sure to delete')){
            ...
            event.preventDefault();
                            ...
                            <form action="{{ route('party.destroy',$item->id)}}" id="delete-form-{{ $item->id }}" method="POST">
                                @csrf
                                @method("DELETE")
                            </form>
