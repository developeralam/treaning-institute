...
@section('title','Party')
@section('page-header')
    <i class="fa fa-plus-circle"></i> Edit Party info
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('party.update',$item->id) }}" >
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="form-field-1-1"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $item->email }}" />
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1"  class="form-control @error('phone') is-invalid @enderror"  pattern="\d*" maxlength="11" minlength="11" name="phone" value="{{ $item->phone }}" />
                                            @error('name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
