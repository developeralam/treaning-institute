            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('addmissionOn.update',$items->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ $items->slug }}" />
                                   @error('slug')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <input multiple="" type="file" id="id-input-file-3" class="form-control"  name="image" />
