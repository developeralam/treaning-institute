...
@section('title','Admission Slide')
@section('page-header')
    <i class="fa fa-plus-circle"></i> Addmission On
@stop
@section('css')
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('addmissionOn.store') }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  placeholder="Title" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Title'" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug') }}" />
                                     @error('slug')
                            ...
                            <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label">  Upload Addmission Slider  <h6>File size must be in <b>(510*382)</b> </h6></label>

                                <div class="col-xs-12 col-sm-6">

                                    <input multiple="" type="file" id="id-input-file-3" class="form-control @error('image') is-invalid @enderror" name="image"  />
                                    @error('image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    {{-- <button class="btn btn-gray" type="Reset"> <i class="fa fa-refresh"></i> Reset</button> --}}
                                     <a href="{{ route('addmissionOn.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
