...
@section('title','Year')
@section('page-header')
    <i class="fa fa-list" xmlns="http://www.w3.org/1999/html"></i> Year
@stop
@section('css')
...
@section('content')
    <div class="page-header">
        <button class="btn btn-xs btn-info" data-toggle="modal" data-target="#exampleModalstore" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</button>
        <h1>
            @yield('page-header')
        </h1>
    </div>
        ...
        <div class="col-xs-12">
            <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
                <table id="dynamic-table" class="table table-striped table-bordered table-hover" >
                    ...
                    <tbody>
                        @foreach(App\Year::getAllYear() as $data)
                                <tr>
                                    <td>{{$loop->index+1}}</td>
                                    <td>{{$data->year}}</td>
                                    <td>{{$data->status_code}}</td>
                                    <td>
                                        <button  data-toggle="modal" data-target="#exampleModal" class="btn btn-sm btn-success">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('year.update',$data->id)}}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="status_code" class="col-form-label">Short Code:</label>
                                                        <input type="number" class="form-control" name="status_code" id="status_code" placeholder="Short Code"  value="{{$data->status_code}}" min="1">
                                                    </div>
                ...
                <div class="modal-body">
                    <form action="{{route('year.store')}}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="number" class="form-control" name="year" id="year" placeholder="Year" value="{{old('year')}}" min="1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-9">
                                <input type="number" class="form-control" name="status_code" id="status_code" placeholder="Short Code"  value="{{old('status_code')}}" min="1">
                            </div>
                        </div>
                        <div style="background-color: #FFF!important;" class="modal-footer">
