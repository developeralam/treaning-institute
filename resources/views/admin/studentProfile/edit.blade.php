            ...
            <div class="widget-box">
              ...
              {{-- @include('admin.layouts.includes.msg') --}}
                <div class="widget-body">
                    ...
                    <form class="form-horizontal" id="studentProfile" method="POST" action="{{ route('studentProfile.update',$item->id) }}"  enctype="multipart/form-data">
                         {{ csrf_field() }}
                         {{ method_field('PUT') }}
                        <div class="row">
...
{{--                                    <label class="col-sm-3 control-label" for="form-field-1-1">2 Name</label>--}}
{{--                                    <div class="col-sm-9">--}}
...
{{--                            </div>--}}
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img class="form-control pull-right" id="" src="{{url('/')}}/{{$item->image}}" alt="{{$item->image}}" style="height: 100px;width: 100px;margin-right: 30px"/>
{{--                                    <input type="text" name="applyImage" value="{{$item->image}}">--}}
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
                            ...
                            <div class="col-sm-3" >
                                <select class="chosen-select session form-control @error('session') is-invalid @enderror " id="std_session" data-placeholder="Choose a Session..." name="session" >
                                    @foreach($sessions as $session)
                                        <option value="">  </option>
                                        <option value="{{ $session->id }}" {{$item->session == $session->id?'selected':''}} >{{ $session->session_name }}</option>
                                    @endforeach
                                </select>
                                @error('session')
                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-3" style="padding-right:35px;">
                                    <select class="chosen-select form-control batch @error('batch') is-invalid @enderror " id="std_batch" data-placeholder="Choose a Batch..." name="batch" >
                                        ...
                                        @foreach($batches as $batch)
                                            <option value="{{ $batch->id }}" {{$item->batch == $batch->id?'selected':''}}>{{$batch->batch_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('batch')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <select class="chosen-select course form-control @error('courseName') is-invalid @enderror " id="std_course" data-placeholder="Choose a Course..." name="courseName">
                                    @foreach($courses as $course)
                                        <option value="">  </option>
                                        <option value="{{ $course->id }}" {{$item->courseName == $course->id?'selected':''}}>{{ $course->title }}</option>
                                    @endforeach
                                </select>
                                @error('courseName')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="student_id"> Student Id</label> <div class="col-sm-5">
                                    <input type="text" id="student_id" class="form-control @error('studentId') is-invalid @enderror" name="studentId" value="{{ $item->studentId }}" readonly/>
                                      @error('studentId')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Student Name <span class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="Text Field" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $item->name }}" />
                                     @error('name')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1">Fathers Name <span class="text-danger">*</span></label>
                             <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="Fathers Name" class="form-control @error('fatherName') is-invalid @enderror " name="fatherName" value="{{ old('fatherName',$item->fatherName??null) }}" />
                             </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1">Mothers Name <span class="text-danger">*</span></label>
                             <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="Mothers Name" class="form-control @error('motherName') is-invalid @enderror " name="motherName" value="{{ old('motherName',$item->motherName??null) }}" />
                             </div>
                            </div>

{{--                            <div class="form-group">--}}
{{--                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> Date of Birth</label>--}}

{{--                                <div class="col-sm-5">--}}
{{--                                    <input type="text" id="form-field-1-1" placeholder="Enter Date of Birth" class="form-control @error('dob') is-invalid @enderror " name="dob" value="{{ old('dob',$item->dob??null) }}" />--}}
{{--                             </div>--}}
{{--                            </div> --}}

                        <div class="form-group">
                            <label for="date_of_birth" class="col-xs-12 col-sm-3 col-md-3 control-label" > Date of Birth <span class="text-danger">*</span></label>
                            <div class="col-sm-5">
                                <input class="form-control date-picker @error('dob') is-invalid @enderror " name="dob" id="date_of_birth" value="{{ old('dob',$item->dob??null) }}" type="text" data-date-format="dd-mm-yyyy" placeholder="Date of birth">
                                @error('dob')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
                           ...
                           <div class="form-group">
                            ...
                            <label>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="form-field-1-1" placeholder="Enter Phone No......" class="form-control @error('phoneNo') is-invalid @enderror"  pattern="\d*" maxlength="11" minlength="11" name="phoneNo" value="{{ old('phoneNo',$item->phoneNo??null) }}" />
                                     @error('phoneNo')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="nid">Nid/Birth Certificate</label>
                            <div class="col-sm-9">
                                <input  type="text" id="nid" placeholder="Enter Nid/Birth Certificate" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Nid/Birth Certificate'" class="form-control @error('phoneNo') is-invalid @enderror"  pattern="\d*" maxlength="17" minlength="10" name="nid" value="{{$item->nid}}" />
                                @error('phoneNo')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                        </span>
                                ...
                                <div class="col-xs-6">
                                    <input type="text" id="form-field-1-1" placeholder="Enter Guardian Phone No......" class="form-control @error('guardianPhoneNo') is-invalid @enderror" pattern="\d*" maxlength="11" minlength="11" name="guardianPhoneNo" value="{{ old('guardianPhoneNo',$item->guardianPhoneNo??null) }}" />
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" id="form-field-1-1" placeholder="Enter email address...." class="form-control" name="email" value="{{ old('email',$item->email??null) }}" />
                                </div>
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="Enter Present address...." class="form-control" name="presentAddress" value="{{ old('presentAddress',$item->presentAddress??null) }}" />
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="Enter Parmanent address...." class="form-control" name="parmanentAddress" value="{{ old('parmanentAddress',$item->parmanentAddress??null) }}" />
                                </div>
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                       <textarea  name="body" style="resize: vertical;" 
            style="width: 50%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; ">{{ $item->body }}</textarea>
                        
                    </div>
                </div>
                   <div class="form-group row">
                                <label class="control-label col-md-3"> Photo </label>
                                <div class="col-md-8" title="file size must be in (2x2)px"> (Square size 150x150)px
                                    <input name="image" class="form-control @error('image') is-invalid @enderror" value="{{ old('image', $item->image??null) }}" type="file" onchange="readURL(this)" accept="image/*"> <br/>
                                    <img id="previewLogo" src="" height="100" width="100"/>
                                    @error('image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label> <input type="radio" name="status" {{$item->status == 1?"checked":""}} value="1"> Active</label> &nbsp;&nbsp;
                                <label> <input type="radio" name="status" {{$item->status == 0?"checked":""}} value="0"> In-Active</label>
                            </div>
                        </div>
