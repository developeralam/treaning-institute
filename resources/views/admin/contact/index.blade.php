    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
             ...
             <td>
                 <a href="{{ route('contact.show',$item->id) }}" class="btn btn-sm btn-success" title="Edit">
                                <i class="fa fa-eye"></i>
            </a> 
         <a  class="btn btn-sm btn-danger" title="Delete" onclick="if(confirm('Are you sure to delete')){
            ...
            event.preventDefault();
                            ...
                            <form action="{{ route('contact.destroy',$item->id)}}" id="delete-form-{{ $item->id }}" method="POST">
                                @csrf
                                @method("DELETE")
                            </form>
