...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Contact Details
@stop
@section('css')
                    ...
                    <div class="widget-main">
                             ...
                             <div class="form-group">
                               ...
                               {{ $item->phone }}
                                ...
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Subject</label>

                               {{ $item->subject }}
                               
                            </div><div class="form-group">
                                <label class="col-sm-3 control-label" for="form-field-1-1"> Message</label>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                   ...
                                   {{--  <button class="btn btn-success"> <i class="fa fa-save"></i> Save</button>
                                    ...
                                    <a href="{{ route('contact.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
