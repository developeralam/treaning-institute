...
@section('title','Photo Gallary Form')
@section('page-header')
    <i class="fa fa-plus-circle"></i> Photo Gallary
@stop
@section('css')
             ...
             @include('admin.layouts.includes.msg')
                <div class="widget-body">
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('photoGallary.update',$item->id) }}"  enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{ method_field('PUT') }}
                          
                              <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label"> Upload Image  <h6>Image size must be in <b>(510x382)px</b> </h6></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    {{-- <button class="btn btn-gray" type="Reset"> <i class="fa fa-refresh"></i> Reset</button> --}}
                                     <a href="{{ route('photoGallary.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
