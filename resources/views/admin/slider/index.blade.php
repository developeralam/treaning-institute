...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{ route('slider.create') }}" role="button" class="blue" data-toggle="modal" style="float: right; margin: 0 2px;"> <i class="fa fa-plus"></i> Add New</a>
    ...
    <div class="row">
     ...
     <td>
      ...
      <img class="img-responsive img-thumbnail" src="{{ asset('uploads/slider/'.$slider->image) }}"  style="height: 50px; weight: 30px;" alt=""> 
      ...
      @endif
             ...
             <td>
                 <a href="{{ route('slider.edit',$slider->id) }}" class="btn btn-sm btn-success" title="Edit">
