...
@section('page-header')
    <i class="fa fa-plus-circle"></i> Slider
@stop
@section('css')
                    ...
                    <div class="widget-main">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('slider.update',$slider->id) }}"  enctype="multipart/form-data">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="form-field-1-1"  class="form-control" name="title" value="{{ $slider->title }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputError" class="col-xs-12 col-sm-3 col-md-3 control-label">Upload Slider Image  <h6>File size must be in <b>(900&nbsp;x&nbsp;340)px</b> </h6></label>
                                <div class="col-xs-12 col-sm-6">                                     
                                    <input multiple="" type="file" id="id-input-file-3" class="form-control  " name="image"  value="{{ old('image', $siteconf->image??null) }}" type="file" onchange="readURL(this)" accept="image/*"/>
                                    <img id="previewLogo" src="/uploads/slider/{{$slider->image??null}}" height="60" width="215"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    {{-- <button class="btn btn-gray" type="Reset"> <i class="fa fa-refresh"></i> Reset</button> --}}
                                     <a href="{{ route('slider.index') }}" class="btn btn-info"> <i class="fa fa-arrow-left"></i> Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
